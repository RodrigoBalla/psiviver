...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-animated p-4 relative">
      ...
      <Link 
        to="/admin-login" 
        className="absolute top-4 right-4 flex items-center gap-2 px-4 py-2 bg-zinc-900/90 backdrop-blur-sm border border-yellow-500/50 rounded-lg text-yellow-500 hover:bg-yellow-500 hover:text-zinc-950 transition-all duration-300 shadow-lg"
      >
