  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // PSIVIVER Custom Colors
        psiviver: {
          roxo: "hsl(var(--roxo-principal))",
          "verde-agua": "hsl(var(--verde-agua))",
          azul: "hsl(var(--azul-medio))",
          "roxo-claro": "hsl(var(--roxo-claro))",
          rosa: "hsl(var(--rosa))",
          "cinza-escuro": "hsl(var(--cinza-escuro))",
          laranja: "hsl(var(--laranja))",
          verde: "hsl(var(--verde))",
          amarelo: "hsl(var(--amarelo))",
          "amarelo-escuro": "hsl(var(--amarelo-escuro))",
        },
      },
      fontFamily: {
